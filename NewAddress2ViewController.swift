//
//  NewAddress2ViewController.swift
//  
//
...
class NewAddress2ViewController: UIViewController ,UITableViewDataSource,UITableViewDelegate {
    ...
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        NSUserDefaults.standardUserDefaults().setObject(indexPath.row, forKey: "rowNumber1")
